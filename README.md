...
Building from source instead? Prerequisites, the three-project dependency install, and linking the global `kanban` command are all in [`installation.md`](./installation.md).
